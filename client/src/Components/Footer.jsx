          ...
          >
            <div className="row g-4">
              <div className="col-lg-3">
                <a href="#">
                  <h1 className="text-primary mb-0">E-krt</h1>
          ...
          <div className="row g-5">
            ...
            <div className="col-lg-3 col-md-6">
              <div className="d-flex flex-column text-start footer-item">
                ...
                <Link className="btn-link" to="/private">
                  Privacy Policy
                </Link>
                <Link className="btn-link" to="/term">
                  Terms & Condition
                </Link>
                <Link className="btn-link" to="/return">
                  Return Policy
                </Link>
            ...
            <div className="col-lg-3 col-md-6">
              <div className="d-flex flex-column text-start footer-item">
                ...
                <a className="btn-link" href="/product">
                  Shop details
                </a>
